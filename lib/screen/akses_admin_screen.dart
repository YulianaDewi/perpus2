import '/screen/daftar_pengguna_screen.dart';
import '/screen/riwayat_peminjaman_screen.dart';
import 'package:flutter/material.dart';

import 'daftar_buku2_screen.dart';
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => DaftarPenggunaScreen()),
                    );
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => DaftarBuku2Screen()),
                    );
                    ScaffoldMessenger.of(context).showSnackBar(
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => RiwayatPeminjamanScreen()),
                );
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                      content: Text('Menampilkan riwayat peminjaman')),
                );
              },
              style: ElevatedButton.styleFrom(
